...
st.html("<h1><span  style='color:orange'>Objectifs</span></h1>\
    ...
    <li>Conjuguer les modèles de machine learning avec ceux de DEEP learning, voire introduire des modèle pré-entraînés comme BERT, GOLVE etc.</li>\
    <li>Tester les modèles élaborés sur des données actuelles issues des sites e-commerce aussi bien RAKUTEN que d'autres fournisseurs de mêmes produits </li></ol>")